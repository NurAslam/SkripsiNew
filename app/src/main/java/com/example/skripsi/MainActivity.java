...
import com.example.skripsi.Fasur.FawasActivity;

import com.example.skripsi.Gharib.GharibActivityMain;
...
MediaPlayer mp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pindah = (ImageButton) findViewById(R.id.buttonGharib);
        pindah.setOnClickListener(new View.OnClickListener() {
            @Override
             
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, GharibActivityMain.class);
                startActivity(intent);
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                suarabutton.start();
                Intent intent = new Intent(MainActivity.this, FawasActivity.class);
                startActivity(intent);
                mp.stop();
            }
        });
